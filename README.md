...
Enkeltfilkomponenter bør alltid være i denne rekkefølgen ```vue<template> <script> <style>``` tagger konsekvent, med <style> sist, fordi minst en av de to andre alltid er nødvendig.
